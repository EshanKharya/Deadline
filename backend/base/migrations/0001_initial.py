    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_name', models.CharField(blank=True, default='', max_length=255, null=True)),
                ...
                ('nationality', models.CharField(default='International', max_length=255)),
                ('github', models.URLField(default='', max_length=255)),
                ('linkedin', models.URLField(default='', max_length=255)),
                ('privacy_status', models.CharField(choices=[('pvt', 'Private'), ('pub', 'Public')], default='pub', max_length=3)),
            ],
        ),
    ]
